 ...
 * @author jefaokpta
 */
@WebServlet(name = "FaxServlet", urlPatterns = {"/FaxServlet"})
public class FaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String pdf=request.getParameter("fax")+".pdf";
            File file = new File("/etc/asterisk/jpbx/pdfs/"+pdf);
            ...
            System.out.println("DEU RUIM AO PEGAR PDF: "+ex.getMessage());
        } finally {
            if (stream != null)
                stream.close();
            if (buf != null)

function loadInternal(url,local)
{
    ...
    xmlhttp.onreadystatechange=function()
    {
		...
		{
            document.getElementById(local).innerHTML='<div style="width:100%;font-family:verdana;font-weight:bold;font-size:12px;color:#666666;text-align:center;" align="center" valign="middle">Conectando na Internet&nbsp;&nbsp;</div>';
		}
		if(xmlhttp.readyState==1)
		{
            //document.getElementById(local).innerHTML='<div style="font-family:verdana;font-weight:bold;font-size:12px;color:#666666;" align="center" valign="middle"><img src="../resources/img/progress_bar_min.gif" /></div>';
		}
		if(xmlhttp.readyState==4)
		{
            document.getElementById(local).innerHTML='<div style="font-family:verdana;font-weight:bold;font-size:12px;color:#666666;" align="center" valign="middle">Finalizando&nbsp;&nbsp;</div>';

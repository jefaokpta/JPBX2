function loadInternal(url,local)
{
    ...
    xmlhttp.onreadystatechange=function()
    {
		...
		{
            document.getElementById(local).innerHTML='<div style="font-family:verdana;font-weight:bold;font-size:12px;color:#666666;" ><img src="../resources/img/progress_bar_min.gif" /></div>';
		}
